...
exports.PAGE_STATUS_VALUES = void 0;
exports.normalizePageSlug = normalizePageSlug;
exports.resolvePageSlug = resolvePageSlug;
exports.coercePageStatus = coercePageStatus;
exports.shouldAutoSetPagePublishedAt = shouldAutoSetPagePublishedAt;
exports.PAGE_STATUS_VALUES = ["draft", "published"];
...
function resolvePageSlug(currentSlug, title) {
...
function coercePageStatus(value) {
    return value === "draft" || value === "published" ? value : null;
}
function shouldAutoSetPagePublishedAt(status, publishedAt) {
    if (status !== "published") {
        return false;
    }
