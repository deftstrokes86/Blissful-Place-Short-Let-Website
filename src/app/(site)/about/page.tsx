...
import { FacilitiesSection } from "@/components/common/FacilitiesSection";
    ...
    <main>
      ...
      <section className="about-page">
        <div className="container about-page-container">
          ...
          >
            <div className="about-hero-copy">
              <span className="subtitle-tag">
                ABOUT BLISSFUL PLACE RESIDENCES
              </span>
              ...
              <p className="about-hero-lead text-secondary">
                Blissful Place Residences is built for guests who value comfort
                without guesswork. We host corporates and young professionals in
                prepared spaces, with clear communication, responsive support,
                and dependable essentials in place before you arrive.
              </p>
              ...
              <div
                className="about-hero-support-links"
                data-reveal=""
                data-reveal-delay="110"
              >
                <span className="text-secondary">
                  Prefer to compare dates first?
                </span>
                <Link
                  href="/availability"
                  className="about-inline-support-link"
                >
                  Check Availability
                </Link>
              </div>
            ...
            >
              ...
              <ul className="about-hero-side-list">
                <li data-reveal="" data-reveal-delay="130">
                  ...
                  <span>
                    Premium short-let accommodation with practical hospitality.
                  </span>
                </li>
                ...
                <li data-reveal="" data-reveal-delay="210">
                  <CheckCircle2 size={15} className="text-primary" />
                  <span>
                    Located in Agbado, Lagos, with easy access to Ikeja, Abule
                    Egba, Meiran, and Egbeda.
                  </span>
                </li>
              </ul>
            </aside>
            ...
            <div className="about-positioning-layout">
              <div className="about-copy-stack">
                <p className="text-secondary">
                  We focus on what makes a stay feel easy: calm surroundings,
                  dependable service, and thoughtful preparation before you
                  arrive.
                </p>
                <p className="text-secondary">
                  Our style is polished and grounded. The goal is simple: help
                  guests settle in quickly, stay productive, and leave confident
                  in the experience.
                </p>
              </div>
              <aside
                className="about-positioning-card"
              ...
              >
                ...
                <ul>
                  ...
                  <li>
                    Responsive support without unnecessary back-and-forth.
                  </li>
                </ul>
              </aside>
            </div>
          ...
          >
            <div className="about-persona-grid">
              ...
              >
                ...
                <p className="text-secondary">
                  Project-based stays that need order, speed, and reliability.
                </p>
              </article>
              <article
                className="about-persona-card"
              ...
              >
                ...
                <p className="text-secondary">
                  Transition periods that call for comfort, calm, and
                  consistency.
                </p>
              </article>
              <article
              ...
              >
                ...
                <p className="text-secondary">
                  Stable internet and a quiet setting that supports productive
                  routines.
                </p>
              </article>
              <article
              ...
              >
                ...
                <p className="text-secondary">
                  Guests who value secure access and respectful on-ground
                  operations.
                </p>
              </article>
            </div>
          ...
          >
            <div className="about-feature-grid">
              ...
              >
                ...
                <p className="text-secondary">
                  Power continuity is treated as essential, not optional, so
                  your stay remains steady.
                </p>
              </article>
              <article
                className="about-feature-card"
              ...
              >
                ...
                <p className="text-secondary">
                  Fast, reliable connectivity for meetings, streaming, and
              ...
              >
                ...
                <p className="text-secondary">
                  Clean interiors, smart TVs, and practical in-room essentials
              ...
              >
                ...
                <p className="text-secondary">
                  Secure gated compound with on-site guards and controlled
                  access that prioritize guest peace of mind.
                </p>
              </article>
            </div>
          </AboutSection>
          ...
          <FacilitiesSection
            className="about-section about-section-soft facilities-section"
            headingId="about-facilities-heading"
            revealDelay={55}
          />
          ...
          >
            <ol className="about-journey-track">
              ...
              >
                ...
                <p className="text-secondary">
                  Review dates and select the stay option that fits your plan.
                </p>
              </li>
              <li
                className="about-journey-step"
              ...
              >
                ...
                <p className="text-secondary">
                  Complete booking with clear terms and straightforward
                  communication.
                </p>
              </li>
              <li
              ...
              >
                ...
                <p className="text-secondary">
                  Get practical updates and direct help through our support
                  channels.
                </p>
              </li>
              <li
              ...
              >
                ...
                <p className="text-secondary">
                  Check in to a space that is organized and ready for your stay.
                </p>
              </li>
            </ol>
          </AboutSection>
          ...
          >
            <div className="about-trust-layout">
              ...
              >
                ...
                <p className="text-secondary">
                  Booking details, check-in guidance, and support options are
                  shared clearly so guests do not have to chase information.
                </p>
              </article>
              <div className="about-trust-grid">
                ...
                >
                  ...
                  <span>
                    Fast-response support expectations built into daily
                    operations.
                  </span>
                </div>
                <div
                ...
                >
                  ...
                  <span>
                    Transparent process from first inquiry to departure.
                  </span>
                </div>
                <div
                  className="about-trust-item"
                ...
                >
                  <Shield size={18} className="text-primary" />
                  <span>
                    Operational discipline that protects comfort and privacy.
                  </span>
                </div>
              </div>
            </div>
          ...
          >
            <div className="about-copy-stack">
              <p className="text-secondary">
                Blissful Place Residences is located at 16 Tebun Fagbemi Street
                in Agbado, a quiet residential area with direct access to the
                Lagos-Abeokuta expressway. We&apos;re a short drive from Ikeja,
                Abule Egba, Meiran, and Egbeda — close enough for easy access to
                mainland Lagos, far enough for genuine peace and quiet.
              </p>
              <p className="text-secondary">
                If you&apos;re looking for a short-let in Ikeja, Abule Egba,
                Meiran, or Egbeda and finding limited availability or noisy
                options, Agbado offers a calmer alternative with better
                infrastructure — silent solar power, fiber internet, and none of
                the generator noise that comes with most mainland short-lets.
              </p>
            </div>
              ...
              >
                ...
                <ul className="about-check-list">
                  <li>
                    ...
                    <span>
                      Pre-arrival checks for cleanliness, power, and internet
                      readiness.
                    </span>
                  </li>
                  <li>
                    <CheckCircle2 size={16} className="text-primary" />
                    <span>
                      In-room setup reviewed so essentials are in place before
                      arrival.
                    </span>
                  </li>
                </ul>
              ...
              >
                ...
                <ul className="about-check-list">
                  <li>
                    <CheckCircle2 size={16} className="text-primary" />
                    <span>
                      Consistent operational follow-through for maintenance and
                      support requests.
                    </span>
                  </li>
                  <li>
                    <CheckCircle2 size={16} className="text-primary" />
                    <span>
                      Clear escalation path when guests need fast issue
                      resolution.
                    </span>
                  </li>
                </ul>
          ...
          >
            <div className="about-inquiry-layout">
              <p className="text-secondary about-copy-max">
                If you are comparing options or unsure which stay setup fits
                your schedule, reach out first. We will respond clearly and help
          ...
          >
            ...
            <p className="text-secondary">
              Check live dates and secure a stay that is calm, prepared, and
              professionally supported from inquiry to check-in.
            </p>
            <div className="about-cta-actions">
              <Link href="/book" className="btn btn-primary">
                Book Your Stay
